 ...
 * Directly pipes chunks and active heartbeats into the HTTP stream to completely bypass Netlify's 10-second limit.
 */
export async function processEmailTranslation(htmlSource, targetDict, sourceDict, brandCode, targetLang, res = null) {
...
`;
  ...
  // =========================================================================
  // OPTIMIZATION: Set up an active network heartbeat to force-keep Netlify awake
  // =========================================================================
  let heartbeatInterval = null;
  if (res && typeof res.write === 'function') {
    // Sends an unnoticeable, clean newline character down the stream pipeline every 2.5 seconds
  ...
  try {
    ...
    // Always clear the timer immediately when the AI processing block terminates
