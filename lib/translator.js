...
export async function processEmailTranslation(htmlSource, targetDict, sourceDict, brandCode, targetLang) {
  ...
  if (!apiKey) {
    throw new Error("GEMINI_API_KEY is not defined in your environment variables. Check your site configuration settings.");
  }
  ...
  // Skip calling the Gemini LLM matrix if the current micro-batch dataset happens to be blank
