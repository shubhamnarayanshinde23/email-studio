 ...
 * Directly pipes chunks into the HTTP stream to bypass Netlify's 10-second limit.
 */
...
`;
  ...
  for await (const chunk of responseStream) {
    ...
    // Send a small keeping-alive heartbeat token to Netlify if response stream is available
